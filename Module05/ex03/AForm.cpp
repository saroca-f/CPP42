...
/*   Updated: 2024/11/17 15:52:26 by saroca-f         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
AForm *AForm::makeForm(std::string const &form, std::string const &target)
{
	AForm *document;

	document = NULL;
	document = PresidentialPardonForm::makeForm(document, form, target);
	document = RobotomyRequestForm::makeForm(document, form, target);
	document = ShrubberyCreationForm::makeForm(document, form, target);
	return(document);
}
